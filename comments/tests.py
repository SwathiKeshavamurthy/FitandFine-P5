...
class CommentModelTestCase(TestCase):
    ...
    def test_comment_ordering(self):
        comment1 = Comment.objects.create(owner=self.user, post=self.post, content='Comment 1')
        comment2 = Comment.objects.create(owner=self.user, post=self.post, content='Comment 2')
        comment3 = Comment.objects.create(owner=self.user, post=self.post, content='Comment 3')
